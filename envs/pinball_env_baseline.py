...
# Optional: try importing for advanced visualization
try:
...
class PinballEnvBaseline(gym.Env):
    ...
    def __init__(self, config: dict = None):
        ...
        self._episode_substep_rewards: list = []  # Detailed per-substep rewards
    ...
    def _save_episode_h5(self):
        ...
        try:
            with h5py.File(filename, 'w') as f:
                ...
                # Drag and Lift (n_steps * num_substeps,)
                ...
                # Substep rewards (n_steps * num_substeps,)
    ...
    def _save_turbulence_snapshot(self, episode: int, step: int = None):
    ...
    def reset(self):
        ...
        # Save previous episode data if any
        if len(self._episode_obs_buffer) > 0:
    ...
    def best_metrics(self) -> dict:
        """Return best metrics seen so far (for external tracking)."""
        return {
